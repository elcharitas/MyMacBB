			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-6 col-lg-6 login-ch-sideBar animated fadeInRightBig">
					...
					<div class="login-container animated fadeInRightBig">
						...
						<h2 class="text-center text-upper">Login To AdminFier Dashboard</h2>
						<form class="form-horizontal">
							...
							<div class="form-group">
								<div class="flex-box align-items-center">
									...
									<p>If You Are a New User <a href="signup.html" data-toggle="tooltip" class="theme-cl" data-original-title="Sign Up">Signup Here.</a></p>
								</div>
							</div>
